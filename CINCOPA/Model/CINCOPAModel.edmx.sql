...
IF OBJECT_ID(N'[dbo].[FK_CRFVISIT_ONE_ONE]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[VisitOneOnes] DROP CONSTRAINT [FK_CRFVISIT_ONE_ONE];
GO
IF OBJECT_ID(N'[dbo].[FK_CRFVISIT_THREE]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[VisitThrees] DROP CONSTRAINT [FK_CRFVISIT_THREE];
GO
IF OBJECT_ID(N'[dbo].[FK_CRFVISIT_TWO]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[VisitTwoes] DROP CONSTRAINT [FK_CRFVISIT_TWO];
GO
...
IF OBJECT_ID(N'[dbo].[FK_VISIT_ONEBASE_LIVE_INDICATORS_VISIT_1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[BaseLiveIndicatorsVisit1Set] DROP CONSTRAINT [FK_VISIT_ONEBASE_LIVE_INDICATORS_VISIT_1];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_ONEANAMNESTIC_DATA]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[AnamnesticDataVisit1Set] DROP CONSTRAINT [FK_VISIT_ONEANAMNESTIC_DATA];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_ONEEVALUATION_OF_SYMPTOMS_VISIT_1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EvaluationOfSymptomsVisit1Set] DROP CONSTRAINT [FK_VISIT_ONEEVALUATION_OF_SYMPTOMS_VISIT_1];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_ONEELECTROCARDIOGRAPHY_VISIT_1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ElectrocardiographyVisit1Set] DROP CONSTRAINT [FK_VISIT_ONEELECTROCARDIOGRAPHY_VISIT_1];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_ONEECHOCARDIOGRAPHY_VISIT_1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EchocardiographyVisit1Set] DROP CONSTRAINT [FK_VISIT_ONEECHOCARDIOGRAPHY_VISIT_1];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_ONEXRAY_CHEST_VISIT_1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[XrayChestVisit1Set] DROP CONSTRAINT [FK_VISIT_ONEXRAY_CHEST_VISIT_1];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_ONECOMPUTED_TOMOGRAPHY_CHEST_VISIT_1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ComputedTomographyChestVisit1Set] DROP CONSTRAINT [FK_VISIT_ONECOMPUTED_TOMOGRAPHY_CHEST_VISIT_1];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_TWOBASE_LIVE_INDICATORS_VISIT_2]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[BaseLiveIndicatorsVisit2Set] DROP CONSTRAINT [FK_VISIT_TWOBASE_LIVE_INDICATORS_VISIT_2];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_TWOEVALUATION_OF_SYMPTOMS_VISIT_2]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EvaluationOfSymptomsVisit2Set] DROP CONSTRAINT [FK_VISIT_TWOEVALUATION_OF_SYMPTOMS_VISIT_2];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_THREEECHOCARDIOGRAPHY_VISIT_3]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EchocardiographyVisit3Set] DROP CONSTRAINT [FK_VISIT_THREEECHOCARDIOGRAPHY_VISIT_3];
GO
IF OBJECT_ID(N'[dbo].[FK_VISIT_ONE_ONEEVALUATION_OF_SYMPTOMS_VISIT_11]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EvaluationOfSymptomsVisit11Set] DROP CONSTRAINT [FK_VISIT_ONE_ONEEVALUATION_OF_SYMPTOMS_VISIT_11];
GO
IF OBJECT_ID(N'[dbo].[FK_CRFBLOOD_CLINICAL_ANALYSIS]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[BloodClinicalAnalyses] DROP CONSTRAINT [FK_CRFBLOOD_CLINICAL_ANALYSIS];
GO
IF OBJECT_ID(N'[dbo].[FK_CRFBLOOD_TESTS_FOR_MARKERS_OF_INFLAMMATION]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[BloodTestsForMarkersOfInflammations] DROP CONSTRAINT [FK_CRFBLOOD_TESTS_FOR_MARKERS_OF_INFLAMMATION];
GO
IF OBJECT_ID(N'[dbo].[FK_CRFBLOOD_TESTS_FOR_MARKERS_OF_CARDIAC_DYSFUNCTION]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[BloodTestsForMarkersOfCardiacDysfunctions] DROP CONSTRAINT [FK_CRFBLOOD_TESTS_FOR_MARKERS_OF_CARDIAC_DYSFUNCTION];
GO
IF OBJECT_ID(N'[dbo].[FK_CRFBLOOD_CHEMISTRY]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[BloodChemistrys] DROP CONSTRAINT [FK_CRFBLOOD_CHEMISTRY];
GO
...
IF OBJECT_ID(N'[dbo].[FK_CRFTEST_FOR_PNEUMOCOCCAL]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TestForPneumococcals] DROP CONSTRAINT [FK_CRFTEST_FOR_PNEUMOCOCCAL];
GO
